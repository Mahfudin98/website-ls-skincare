      ...
      <label htmlFor="galeri" className="cursor-pointer modal z-[99999]">
        <label className="relative max-w-5xl modal-box bg-pic-200" htmlFor="">
          ...
          <div className="grid grid-cols-2 gap-2 py-3 mt-3 lg:mt-0 md:grid-cols-4">
            ...
            <div className="h-32 w-full bg-pic-500 aspect-[4/3] md:aspect-[3/4] xl:aspect-[4/3] rounded-lg"></div>
            <div className="h-32 w-full bg-pic-500 aspect-[4/3] md:aspect-[3/4] xl:aspect-[4/3] rounded-lg md:col-start-3"></div>
            <div className="h-32 w-full bg-pic-500 aspect-[4/3] md:aspect-[3/4] xl:aspect-[4/3] rounded-lg"></div>
            <div className="h-32 w-full bg-pic-500 aspect-[4/3] md:aspect-[3/4] xl:aspect-[4/3] rounded-lg"></div>
            <div className="h-32 w-full bg-pic-500 aspect-[4/3] md:aspect-[3/4] xl:aspect-[4/3] rounded-lg"></div>
            <div className="h-32 w-full bg-pic-500 aspect-[4/3] md:aspect-[3/4] xl:aspect-[4/3] rounded-lg md:col-start-2"></div>
            <div className="h-32 w-full bg-pic-500 aspect-[4/3] md:aspect-[3/4] xl:aspect-[4/3] rounded-lg md:col-start-4"></div>
            <div className="h-32 w-full bg-pic-500 aspect-[4/3] md:aspect-[3/4] xl:aspect-[4/3] rounded-lg"></div>
            <div className="h-32 w-full bg-pic-500 aspect-[4/3] md:aspect-[3/4] xl:aspect-[4/3] rounded-lg md:col-start-3"></div>
            <div className="h-32 w-full bg-pic-500 aspect-[4/3] md:aspect-[3/4] xl:aspect-[4/3] rounded-lg md:col-start-3"></div>
          </div>
